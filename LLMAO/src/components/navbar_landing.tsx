        ...
        <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
          ...
          <Flex alignItems={'center'}>
            ...
            <Box
              ...
              <Box
                as="a"
                px={2} py={1} borderRadius={'md'} fontSize={18} rounded={'md'} _hover={{textDecoration: 'none',transform: "scale(1.05)",color: 'white' , bg: useColorModeValue('purple.500', 'purple.300'),}} transition="transform 0.3s" _active={{ bg: 'purple.500'}} href={'/singup'}
              >
