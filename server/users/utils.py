...
def generate_pdf(pdf_file_path, modulename, module_summary, submodule_content, src_lang):
    ...
    content = [
        Image('LLMAO/src/assets/images/logo.png', width=100, height=100),  # replace with the actual dimensions of your logo
...
def add_page_number(canvas, doc):
    ...
    canvas.drawRightString(200*mm, 20*mm, text)  # Adjust the position as needed
